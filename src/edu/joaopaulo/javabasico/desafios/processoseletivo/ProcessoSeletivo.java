package edu.joaopaulo.javabasico.desafios.processoseletivo;
...
public class ProcessoSeletivo {
    ...
    public static void selecaoCandidatos() {
        ...
        while (candidatosSelecionados < 5 && candidatosAtual < candidatos.length) {
            ...
            System.out.println("O candidato " + candidato + " Solicitou este valor de salário " + String.format("%.1f", salarioPretendido));
